...
\'Etant donn\'e que la corr\'elation entre ar\^etes n\'eglige la position du sommet dans celle-ci, la matrice de corr\'elation binaire est la matrice $matE$ d'adjacence du line-graphe $L(G)$ sous-jacent au graphe non orient\'e de $G$.
\newline
Nous considerons la symm\'etrie superieure de $matE$ car nous supposons $G$ comme un graphe non orient\'e. 
Toutes les cases $\mu[i,j] = 1$ de $matA$ sont num\'erot\'ees et forment les sommets de la matrice $matA$ 

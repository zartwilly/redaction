...
\'Etant donn\'e que la corr\'elation entre ar\^etes n\'eglige la position du sommet dans celle-ci, la matrice de corr\'elation binaire est la matrice $matE$ d'adjacence du line-graphe $L(G)= (E, A)$. %sous-jacent au graphe non orient\'e de $G$.
\newline
